...
public interface TicketReportRepository extends JpaRepository<TicketReport, Long>, TicketReportRepositoryCustom {
    ...
    Optional<TicketReport> findByTicketReportUUID(String ticketReportUUID);
}
